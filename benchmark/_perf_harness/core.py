...
generator in benchmark/_perf_harness/dual.py.
"""
...
KIND10 = (
    ...
    'esyr yher esyr2 yher2 escal eaxpy ecopy eswap erot edot easum '
    'yscal yescal yaxpy ycopy yswap yerot ydotu ydotc '
    'eyasum egbmv ygbmv esbmv yhbmv espmv yhpmv etbmv ytbmv '
    'etbsv ytbsv etpmv ytpmv etpsv ytpsv espr yhpr espr2 yhpr2 '
...
KIND16 = (
    ...
    'qsyr xher qsyr2 xher2 qscal qaxpy qcopy qswap qrot qdot qasum '
    'xscal xqscal xaxpy xcopy xswap xqrot xdotu xdotc '
    'qxasum qgbmv xgbmv qsbmv xhbmv qspmv xhpmv qtbmv xtbmv '
    'qtbsv xtbsv qtpmv xtpmv qtpsv xtpsv qspr xhpr qspr2 xhpr2 '
...
MULTIFLOATS = (
    ...
    'msyr wher msyr2 wher2 mscal wscal wmscal maxpy waxpy mcopy wcopy '
    'mswap wswap mrot wmrot mdot masum mwasum wdotu wdotc '
    'mgbmv wgbmv msbmv whbmv mspmv whpmv mtbmv wtbmv '
    'mtbsv wtbsv mtpmv wtpmv mtpsv wtpsv mspr whpr mspr2 whpr2 '
    'mcabs1 mnrm2 mwnrm2 '
