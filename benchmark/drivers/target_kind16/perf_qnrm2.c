 ...
 *
 * Kernel-isolated C perf harness for qnrm2 (overlay vs migrated).
...
BLAS_EXTERN Q16 qnrm2_(const int *, const Q16 *, const int *);
BLAS_EXTERN Q16 qnrm2_migrated_(const int *, const Q16 *, const int *);
