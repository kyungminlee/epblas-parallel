...
#   2. namespace them into lib_{par,ob,mig}_ns.a          [benchmark/dual/nsbuild.sh]
#   3. generate one dual driver per routine               [benchmark/gen_dual_harnesses.py]
...
#   6. aggregate into the scoreboard                      [benchmark/dual/agg_dual.py]
#
# Usage:
#   benchmark/dual/run_dual.sh <family> [routine,routine,...]
...
GENLIST="$(python3 "$ROOT/benchmark/gen_dual_harnesses.py" "${GENARGS[@]}" --list)"
