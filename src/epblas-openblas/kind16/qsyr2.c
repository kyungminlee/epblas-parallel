/*
 * qsyr2 — kind16 port of OpenBLAS dsyr2.  Symmetric rank-2 update.
 *
 ...
 *
 * Fortran ABI:  subroutine qsyr2(uplo, n, alpha, x, incx, y, incy, a, lda)
 */
...
void qsyr2_(const char *UPLO, const int *N, const T *ALPHA,
