/*
 * iqamax — kind16 port of OpenBLAS idamax.
 *
...
static inline T q_abs(T a) { return __builtin_fabsf128(a); }
...
int iqamax_(const int *N, const T *x, const int *INCX)
{
    ...
    if (n > MULTI_THREAD_MINIMAL) {
        ...
        if (nthreads > 1) {
            ...
            ptrdiff_t gidx = 0;
            T gmax = -1.0Q;  /* will be overwritten by first valid */
            int first = 1;
