/*
 * qsymv — kind16 port of OpenBLAS dsymv.  Symmetric matrix-vector.
 *
...
void qsymv_(const char *UPLO, const int *N, const T *ALPHA,
            ...
            const T *BETA, T *y, const int *INCY)
{
    ...
    if (beta != 1.0Q) {
        ...
        ptrdiff_t iy = 0;
        if (beta == 0.0Q) {
            for (ptrdiff_t i = 0; i < n; ++i) { y[iy] = 0.0Q; iy += absy; }
        } else {
