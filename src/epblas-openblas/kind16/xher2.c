/*
 * xher2 — kind16 port of OpenBLAS zher2.  Hermitian rank-2 update.
 *
 ...
 *
 * Fortran ABI:  subroutine xher2(uplo, n, alpha, x, incx, y, incy, a, lda)
 */
...
void xher2_(const char *UPLO, const int *N, const C *ALPHA,
