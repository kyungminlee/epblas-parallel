/*
 * xqscal — kind16 port of OpenBLAS zdscal.  x := alpha*x, alpha REAL.
 *
 * NETLIB bail: incx <= 0 is a no-op (matches blas/src/xqscal.f and
 ...
 * fmuls written explicitly.  Borrowed from epblas-parallel/kind16/xqscal.c
...
void xqscal_(const int *N, const T *ALPHA, C *x, const int *INCX)
{
