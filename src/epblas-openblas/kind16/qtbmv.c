/*
 * qtbmv — kind16 port of OpenBLAS dtbmv (interface/tbmv.c +
 ...
 *
 * Fortran ABI:  subroutine qtbmv(uplo, trans, diag, n, k, a, lda, x, incx)
 */
...
void qtbmv_(const char *UPLO, const char *TRANS, const char *DIAG,
