/*
 * qaxpy — kind16 (REAL(KIND=16) / 128-bit __float128) port of OpenBLAS daxpy.
 *
 * Y := alpha * X + Y
 *
 ...
 *   - No SIMD. x86_64 has no AVX path for 128-bit __float128.
 ...
 *   - alpha, x, y: REAL(KIND=16)  ↔  __float128
 */
...
void qaxpy_(const int *N, const T *ALPHA,
