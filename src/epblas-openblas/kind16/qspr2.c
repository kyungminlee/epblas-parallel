/*
 * qspr2 — kind16 port of OpenBLAS dspr2.  Packed symmetric rank-2 update.
 *
 ...
 *
 * Fortran ABI:  subroutine qspr2(uplo, n, alpha, x, incx, y, incy, ap)
 */
...
void qspr2_(const char *UPLO, const int *N, const T *ALPHA,
