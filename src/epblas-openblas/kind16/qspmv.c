/*
 * qspmv — kind16 port of OpenBLAS dspmv.  Packed symmetric matrix-vector.
 *
 ...
 *
 * Fortran ABI:  subroutine qspmv(uplo, n, alpha, ap, x, incx, beta, y, incy)
 */
...
void qspmv_(const char *UPLO, const int *N, const T *ALPHA,
            const T *ap,
