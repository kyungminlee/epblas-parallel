/*
 * xscal — kind16 port of OpenBLAS zscal.  x := alpha*x, alpha complex.
 *
 * NETLIB bail: incx <= 0 is a no-op (matches blas/src/xscal.f and
 ...
 * insns / 1 fxch). Borrowed from epblas-parallel/kind16/xscal.c —
...
void xscal_(const int *N, const C *ALPHA, C *x, const int *INCX)
{
