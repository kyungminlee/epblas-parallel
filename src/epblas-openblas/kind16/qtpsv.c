/*
 * qtpsv — kind16 port of OpenBLAS dtpsv.  Packed triangular solve.
 *
 ...
 *
 * Loop directions and KK walk match Fortran reference qtpsv.f.
 *
 * Fortran ABI:  subroutine qtpsv(uplo, trans, diag, n, ap, x, incx)
 */
...
void qtpsv_(const char *UPLO, const char *TRANS, const char *DIAG,
