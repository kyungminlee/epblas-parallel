/*
 * qtrmv — kind16 port of OpenBLAS dtrmv (interface/trmv.c +
 ...
 *
 * Fortran ABI:  subroutine qtrmv(uplo, trans, diag, n, a, lda, x, incx)
 */
...
void qtrmv_(const char *UPLO, const char *TRANS, const char *DIAG,
