/*
 * qdot — kind16 port of OpenBLAS ddot.  Returns x^T y.
 *
 * gfortran ABI: REAL(KIND=16) function returns __float128 by value.
 */
#include <stddef.h>
#include <quadmath.h>
#ifdef _OPENMP
...
T qdot_(const int *N, const T *x, const int *INCX,
