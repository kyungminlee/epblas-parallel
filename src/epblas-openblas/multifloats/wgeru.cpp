/*
 * wgeru — kind10 port of OpenBLAS zgeru.  Complex unconjugated outer product.
 *
 *   A := alpha * x * y^T + A     (no conjugate on y)
 *
 * Fortran ABI:  subroutine wgeru(m, n, alpha, x, incx, y, incy, a, lda)
 */
...
extern "C" void wgeru_(const int *M, const int *N, const C *ALPHA,
