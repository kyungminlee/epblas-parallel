/*
 * mgbmv — kind10 port of OpenBLAS dgbmv (interface/gbmv.c +
...
extern "C" void mgbmv_(const char *TRANS, const int *M, const int *N,
            ...
            size_t trans_len)
{
    ...
    if (beta != 1.0) {
        ...
        ptrdiff_t iy = 0;
        if (beta == 0.0) for (ptrdiff_t i = 0; i < leny; ++i) { y[iy] = 0.0; iy += absy; }
