/*
 * mspr — kind10 port of OpenBLAS dspr.  Packed symmetric rank-1 update.
 *
 ...
 *
 * Fortran ABI:  subroutine mspr(uplo, n, alpha, x, incx, ap)
 */
...
extern "C" void mspr_(const char *UPLO, const int *N, const T *ALPHA,
