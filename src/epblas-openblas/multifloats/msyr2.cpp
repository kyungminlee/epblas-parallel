/*
 * msyr2 — kind10 port of OpenBLAS dsyr2.  Symmetric rank-2 update.
 *
 ...
 *
 * Fortran ABI:  subroutine msyr2(uplo, n, alpha, x, incx, y, incy, a, lda)
 */
...
extern "C" void msyr2_(const char *UPLO, const int *N, const T *ALPHA,
