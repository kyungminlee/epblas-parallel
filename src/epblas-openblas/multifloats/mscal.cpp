/*
 * mscal — kind10 port of OpenBLAS dscal.  x := alpha * x.
 *
 * Reference bails on incx <= 0 (matches blas/src/mscal.f).
 */
#include <stddef.h>
...
extern "C" void mscal_(const int *N, const T *ALPHA, T *x, const int *INCX)
{
