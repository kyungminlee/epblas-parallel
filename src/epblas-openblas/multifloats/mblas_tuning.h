/*
 * mblas_tuning.h — shared tuning constants for the multifloats double-double
 * (float64x2) hand-ported OpenBLAS comparison leg.
 *
 ...
 * footprints coincide.
 */
#ifndef MBLAS_TUNING_H
#define MBLAS_TUNING_H
...
#define MBLAS_MT_MIN_L1     10000
#define MBLAS_MT_MIN_L2_NN  16384
#define MBLAS_MT_MIN_L2_MN  4096

/* L3 pack-panel footprint target: the adaptive-MC growth for small K aims
 * an MC*KC slab at this many bytes (P-core L2 nominal). */
#define MBLAS_L2_TARGET_BYTES (256L * 1024L)
...
#define MBLAS_L1_MAX_THREADS  64

#endif /* MBLAS_TUNING_H */
