/*
 * whpr2 — kind10 port of OpenBLAS zhpr2.  Hermitian packed rank-2 update.
 *
 ...
 * forward-mapped.
 *
 * Fortran ABI:  subroutine whpr2(uplo, n, alpha, x, incx, y, incy, ap)
 */
...
extern "C" void whpr2_(const char *UPLO, const int *N, const C *ALPHA,
