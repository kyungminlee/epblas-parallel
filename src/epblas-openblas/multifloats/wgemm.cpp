/*
 * wgemm — kind10 (COMPLEX(KIND=10)) port of OpenBLAS ZGEMM.
 *
 ...
 *   - kernel/generic/
 *       zgemmkernel_2x2.c      → mblas_ygemm_kernel  (NN path only;
 *                                                     conjugation absorbed
 *                                                     into the packers)
 *       zgemm_ncopy_2.c         → mblas_ygemm_ncopy
 *       zgemm_tcopy_2.c         → mblas_ygemm_tcopy
 ...
 *     grown so MC*KC of complex `multifloats::float64x2` fits the L2 target).
 *
 * Fortran ABI:
    ...
    T *c, const int *ldc_)
{
    ...
    /* Pack-buffer sizes: 2 multifloats::float64x2s per complex element. */
