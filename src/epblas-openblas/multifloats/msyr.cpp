/*
 * msyr — kind10 port of OpenBLAS dsyr.  Symmetric rank-1 update.
 *
 ...
 *
 * Fortran ABI:  subroutine msyr(uplo, n, alpha, x, incx, a, lda)
 */
...
extern "C" void msyr_(const char *UPLO, const int *N, const T *ALPHA,
