/*
 * mtpmv — kind10 port of OpenBLAS dtpmv (interface/tpmv.c +
 ...
 *
 * Serial path mirrors Fortran reference mtpmv.f — kk walks the packed
 * column pointer in lock-step with the loop direction.
 *
 * Fortran ABI:  subroutine mtpmv(uplo, trans, diag, n, ap, x, incx)
 */
...
extern "C" void mtpmv_(const char *UPLO, const char *TRANS, const char *DIAG,
