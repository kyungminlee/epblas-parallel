/*
 * mtbsv — kind10 port of OpenBLAS dtbsv.  Banded triangular solve.
 *
 ...
 *
 * Fortran ABI:  subroutine mtbsv(uplo, trans, diag, n, k, a, lda, x, incx)
 */
...
extern "C" void mtbsv_(const char *UPLO, const char *TRANS, const char *DIAG,
