 ...
 *
 * ABI: ygemm_serial is the by-value core entry (char/ptrdiff_t by value,
 * alpha/beta by pointer); the public Fortran entry ygemm_ lives in
 * ygemm_parallel.c behind common/epblas_facade.h. Character args are bare
