...
typedef _Complex long double ysymm_TC;
 ...
 * [0, M). */
void ysymm_beta_only(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m, ysymm_TC beta,
                     ysymm_TC *c, ptrdiff_t ldc);
...
void ysymm_L_singleblock(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m,
                         ysymm_TC alpha, ysymm_TC beta,
                         const ysymm_TC *a, ptrdiff_t lda,
                         const ysymm_TC *b, ptrdiff_t ldb,
                         ysymm_TC *c, ptrdiff_t ldc, char UPLO);

/* SIDE='L' general path, one column panel [jc, jc+jb): beta pre-scale +
 * I/K block loops (ygemm_serial trailing) + scalar diagonal block. */
void ysymm_L_panel(ptrdiff_t jc, ptrdiff_t jb, ptrdiff_t m, ysymm_TC alpha, ysymm_TC beta,
                   const ysymm_TC *a, ptrdiff_t lda, const ysymm_TC *b, ptrdiff_t ldb,
                   ysymm_TC *c, ptrdiff_t ldc, char UPLO, ptrdiff_t nb);

/* SIDE='R' general path, one row panel [ic, ic+ib): beta pre-scale +
 * J/K block loops (ygemm_serial trailing) + scalar diagonal block. */
void ysymm_R_panel(ptrdiff_t ic, ptrdiff_t ib, ptrdiff_t n, ysymm_TC alpha, ysymm_TC beta,
                   const ysymm_TC *a, ptrdiff_t lda, const ysymm_TC *b, ptrdiff_t ldb,
                   ysymm_TC *c, ptrdiff_t ldc, char UPLO, ptrdiff_t nb);
...
void ysymm_serial(
    ...
    const ysymm_TC *alpha_,
    const ysymm_TC *a, ptrdiff_t lda,
    const ysymm_TC *b, ptrdiff_t ldb,
    const ysymm_TC *beta_,
    ysymm_TC *c, ptrdiff_t ldc);
