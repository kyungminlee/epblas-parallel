...
int egemmtr_round_up(int v, int m) { return ((v + m - 1) / m) * m; }
...
void egemmtr_pack_A(const T *restrict A, int lda,
...
void egemmtr_pack_B(const T *restrict B, int ldb,
...
void egemmtr_macro_kernel_rect(int ib, int jb, int pb, T alpha,
...
void egemmtr_macro_kernel_tri(int ib, int jb, int pb, T alpha,
                              const T *restrict Ap, const T *restrict Bp,
                              T *restrict C, int ldc,
