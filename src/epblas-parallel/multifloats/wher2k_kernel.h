...
void wher2k_zero_diag_im(int j, wher2k_T *c, int ldc);
...
void wher2k_scale_col(int j, int N, char UPLO, wher2k_R beta,
                      wher2k_T *c, int ldc);
...
void wher2k_block(int jc, int jb, int N, int K, char UPLO, char TR,
                  ...
                  const wher2k_T *a, int lda, const wher2k_T *b, int ldb,
                  wher2k_T *c, int ldc);
