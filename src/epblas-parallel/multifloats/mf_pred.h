...
inline bool eq0(TR x) { return x.limbs[0] == 0.0 && x.limbs[1] == 0.0; }
...
inline bool eq1(TR x) { return x.limbs[0] == 1.0 && x.limbs[1] == 0.0; }
...
inline TR mag(TR a) { return a < 0 ? -a : a; }

inline bool abs_gt(TR a, TR b) { return gt(mag(a), mag(b)); }
