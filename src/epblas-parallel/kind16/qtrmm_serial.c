...
/* B := alpha · L · B */
void trmm_lln_core(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m, TR alpha,
...
/* B := alpha · U · B */
void trmm_lun_core(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m, TR alpha,
                   const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
    for (ptrdiff_t j = j_start; j < j_end; ++j) {
...
/* B := alpha · Lᵀ · B */
void trmm_llt_core(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m, TR alpha,
                   const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
    for (ptrdiff_t j = j_start; j < j_end; ++j) {
...
/* B := alpha · Uᵀ · B */
void trmm_lut_core(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m, TR alpha,
                   const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
    for (ptrdiff_t j = j_start; j < j_end; ++j) {
...
/* B := alpha · B · L */
void trmm_rln_core(ptrdiff_t i_start, ptrdiff_t i_end, ptrdiff_t n, TR alpha,
                   const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
...
/* B := alpha · B · U */
void trmm_run_core(ptrdiff_t i_start, ptrdiff_t i_end, ptrdiff_t n, TR alpha,
                   const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
...
/* B := alpha · B · Lᵀ */
void trmm_rlt_core(ptrdiff_t i_start, ptrdiff_t i_end, ptrdiff_t n, TR alpha,
                   const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
...
/* B := alpha · B · Uᵀ */
void trmm_rut_core(ptrdiff_t i_start, ptrdiff_t i_end, ptrdiff_t n, TR alpha,
                   const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
