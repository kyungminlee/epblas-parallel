/*
 * xgemm_serial.c — kind16 complex (COMPLEX(KIND=16) / __complex128) GEMM,
 * serial core.
 *
 ...
 * xgemm_kernel.h), plus the public `xgemm_serial_` Fortran entry. No
 ...
 *
 * Both xgemm_serial_ and the parallel xgemm_ drive numerics through
 * xgemm_tile_compute, so the two paths are bitwise-identical.
 */
