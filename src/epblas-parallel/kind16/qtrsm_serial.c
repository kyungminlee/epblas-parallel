...
void qtrsm_lln_core(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m, TR alpha,
...
void qtrsm_lun_core(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m, TR alpha,
                    const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
    for (ptrdiff_t j = j_start; j < j_end; ++j) {
        if (alpha != 1.0Q) for (ptrdiff_t i = 0; i < m; ++i) B_(i, j) *= alpha;
...
void qtrsm_llt_core(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m, TR alpha,
                    const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
    for (ptrdiff_t j = j_start; j < j_end; ++j) {
...
void qtrsm_lut_core(ptrdiff_t j_start, ptrdiff_t j_end, ptrdiff_t m, TR alpha,
                    const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
    for (ptrdiff_t j = j_start; j < j_end; ++j) {
...
void qtrsm_rln_core(ptrdiff_t i_start, ptrdiff_t i_end, ptrdiff_t n, TR alpha,
                    const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
    for (ptrdiff_t j = n - 1; j >= 0; --j) {
        ...
        if (nounit) {
            const TR inv = 1.0Q / A_(j, j);
            for (ptrdiff_t i = i_start; i < i_end; ++i) B_(i, j) *= inv;
        }
    }
}

void qtrsm_run_core(ptrdiff_t i_start, ptrdiff_t i_end, ptrdiff_t n, TR alpha,
                    const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
...
void qtrsm_rlt_core(ptrdiff_t i_start, ptrdiff_t i_end, ptrdiff_t n, TR alpha,
                    const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
    for (ptrdiff_t k = 0; k < n; ++k) {
        if (nounit) {
            const TR inv = 1.0Q / A_(k, k);
...
void qtrsm_rut_core(ptrdiff_t i_start, ptrdiff_t i_end, ptrdiff_t n, TR alpha,
                    const TR *a, ptrdiff_t lda, TR *b, ptrdiff_t ldb, bool nounit)
{
